...
import { getChatRooms, createChatRoom, getAllRooms, deleteChatRoom } from "../controllers/chatRoomController"
...
router.delete("/chatrooms/:roomId", authenticate, deleteChatRoom);
